                    ...
                    <div className="mt-8">
                        ...
                        {isWomenOpen && (
                            <div className="space-y-3">
                                <button onClick={() => navigate('/AdminWomenList')} className="w-full bg-gray-800 hover:bg-gray-700 text-white text-lg font-semibold p-3 rounded-lg transition duration-200 ease-in-out transform hover:scale-105">
                                    Ürün Listesi
                                </button>
                                ...
                                <button className="w-full bg-gray-800 hover:bg-red-600 text-white text-lg font-semibold p-3 rounded-lg transition duration-200 ease-in-out transform hover:scale-105">
                                    Ürün Sil
                                </button>
                            </div>
                        )}
