...
function AdminManShoesCount() {
    const [brandCounts, setBrandCounts] = useState({})

    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('http://localhost:5029/api/ManShoe')
    ...
    return (
        <div className="p-4">
            <h2 className="text-xl font-semibold mb-4">Erkek Ayakkabı Stok Sayıları</h2>
...
export default AdminManShoesCount
