        ...
        <header className="w-full top-0 bg-white shadow-md z-50">
            ...
            <div className="w-full bg-white/95 flex flex-col lg:flex-row items-center justify-center border-b-4 border-black/90 px-4 py-4 space-y-4 lg:space-y-0 lg:space-x-8">
                ...
                <div className="flex items-center space-x-1 cursor-pointer" onClick={() => navigate('/')}>
                    <h1 className="text-4xl sm:text-5xl lg:text-7xl font-serif text-black select-none">StepCity</h1>
                ...
                <div className="w-[350px] lg:w-[600px] flex items-center gap-3">
                    {/* Arama Kutusu */}
                    <div className="flex flex-1 items-center border-2 border-black rounded bg-neutral-100 px-3 py-2">
                    ...
                    <div
                        ...
                        className="flex items-center border-2 border-black rounded px-2 py-2 hover:bg-neutral-300 cursor-pointer select-none relative h-11 w-[100px] lg:w-[120px]"
                    >
                ...
                {searchTerm && (isSearching || searchResults.length > 0) && (
                    <div className="w-full max-w-2xl relative mt-2 z-[9999]">
                        {isSearching ? (
                            <div className="absolute w-full bg-white shadow-lg border border-black rounded mt-1">
                                <div className="p-2 text-center">Yükleniyor...</div>
                            </div>
                        ) : (
                            <div className="absolute w-full bg-white shadow-lg border border-black rounded mt-1 max-h-64 overflow-y-auto">
            ...
            {/* Alt Menü */}
            <div className="flex justify-center flex-wrap gap-x-4 gap-y-2 bg-black text-white text-lg sm:text-xl py-2 px-4 select-none">
                <h1 onClick={() => navigate('/Kadın-Ayakkabı')} className="cursor-pointer hover:text-neutral-400 duration-200">Kadın</h1>
                <span className="hidden sm:block h-6 w-0.5 bg-white" />
